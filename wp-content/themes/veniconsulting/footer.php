    ...
    <div class="row row-md-1 row-lg-4 mx-0">
        ...
        <div class="col text-center">
            ...
            <div class="footer-slot my-1 d-flex flex-column">
                ...
                <a href="vision.html">Unsere Vision</a>
                <a href="about.html">Über uns</a>
            </div>
            <div class="footer-slot my-3 d-flex flex-column">
                <a href=glossar.html>Nachhaltigkeitsglossar</a>
                <a href="blog.html">Nachhaltigkeitsblog</a>
            </div>
        </div>
        ...
        <div class="col text-center">
            ...
            <div class="footer-slot my-1 d-flex flex-column">
                ...
                <div class="fs-5 my-2">
                    ...
                    <a href="kontakt.html">kontakt@veni-consulting.de</a>
                </div>
            </div>
        </div>
    </div>
